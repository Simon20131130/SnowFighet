...
// ===== STATIKUS TEXTÚRA =====
sf::Texture Snowball::s_texture;
bool Snowball::s_loaded = false;
...
// ===== KONSTRUKTOR =====
Snowball::Snowball(sf::Vector2f pos, sf::Vector2f dir)
{
    if (!s_loaded)
    {
        s_texture.loadFromFile("resources/snowball.png");
        s_loaded = true;
    }
    ...
    m_velocity = normalize(dir) * 500.f;
    m_startPos = pos;
}
...
sf::Vector2f Snowball::getVelocity() const
{
    return m_velocity;
}
